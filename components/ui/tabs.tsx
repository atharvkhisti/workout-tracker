...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-start gap-1 rounded-md bg-zinc-900 p-1 text-zinc-400 overflow-x-auto w-full",
      className
    )}
    {...props}
  />
